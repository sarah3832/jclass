...
//		System.out.println(Math.round(102.9820));  // 소수점 첫째자리에서 반올림
//		System.out.println(Math.floor(102.9820));  // 소수점 첫째자리에서 버림
//		System.out.println(Math.ceil(102.9820));  // 소수점 첫째자리에서 올림
